...
for chunk_idx, chunk in enumerate(reader):
    ...
    # MEMORY FIX: explicitly drop references to the chunk + any submasks
    # before the next iteration, and periodically force a gc pass. On long
    # Windows runs over a 31GB file, letting pandas chunk fragments pile up
    # before a natural gc cycle can bloat working-set memory noticeably.
    del chunk, sub, mask
